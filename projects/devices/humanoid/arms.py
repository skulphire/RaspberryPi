...
class Arms(object):
    ...
    def leftShoulder(self, degrees,speed):
        if degrees % 5 == 0:
            ...
            help.channels.append(0)
            self.lsLastPulse = pulse
            help.controller.append(2)
